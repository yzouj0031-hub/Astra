...
CAMERAS = {
    ...
    # 广场与茶馆：站在河面上往东北看，牌坊在左、茶馆在右
    # （第一版摆在 (34,7,2) 只有 15 米远，整屏一面墙）
    "teahouse": ((0.0, 9.0, 1.0), (19.0, 4.5, 17.0), 30.0),
    # 山上的宝塔。塔高约 21 米（塔基在山顶 y=20），要退到 70 米开外
    # 才装得下 —— 第一版在 (-64,34,44) 太近，塔顶直接截掉了
    "pagoda": ((-66.0, 30.0, 26.0), (-112.0, 26.0, 84.0), 45.0),
    # 全镇鸟瞰
